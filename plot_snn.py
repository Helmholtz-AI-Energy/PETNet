...
if __name__ == "__main__":
    ...
    net = Net(num_steps=arguments.timesteps,
              num_inputs=arguments.nodes,
              num_hidden=arguments.hiddenlayer,
              num_outputs=arguments.outputs,
              beta=arguments.constant)
    ...
    if os.path.isfile(arguments.modelpath):
        ...
        with torch.no_grad():
            ...
            for test_data, test_targets in test_loader:
                ...
                plot_snn_spikes(test_data[:,0], test_targets[:,0], test_spk[:,0], "Fully Connected Spiking Neural Network", entry, arguments)
                entry += 1
